...
?>
	...
	<div id="main">
		...
		<div id="chambreCoteCiel">
			...
			<p>
				<strong>Haute saison:</strong> mai à octobre, <strong>prix entre 89$ et 99$</strong> selon les dates.
		...
		<div>
			...
			<p>
				<strong>
					<i>
						Les petits déjeuners "maison" sont inclus dans le prix de la chambre!<br><br>
						Gîte Côté-Lac est partenaire avec le Parc du Mont-Mégantic; pensez à demander votre rabais pour les activités d'astronomie!
					</i>
				</strong>
			</p>
		</div>
